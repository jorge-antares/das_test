...
\begin{frame}{Date, Time and Location}
    \begin{itemize}
        \item \textcolor{blue}{\texttt{date}}: Ambiguity in YY-MM-DD or DD-MM-YY formats is resolved by assuming the former. Parse `DD-Mon-YY' to `YYYY-MM-DD', or None/Null on failure. UTF?
        \vspace{0.3cm}
