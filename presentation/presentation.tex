...
\begin{frame}{Date, Time and Location}
    \begin{itemize}
        \item \textcolor{blue}{\texttt{date}}: Somewhat consistent format. Parse `DD-Mon-YY' to `YYYY-MM-DD' or None/Null on failure. Potential ambiguity: YY-MM-DD or DD-MM-YY and UTF time standard?. 
        \vspace{0.3cm}
        \item \textcolor{blue}{\texttt{time}}: Universal format. Normalise to `HH:MM' (24-hour). Strips prefix `c' with optional space.\\
            4-digit integers (e.g. `1730' to `17:30'). Returns None for unparseable values.
        \vspace{0.3cm}
